...
// State Management
let currentStep = 'HERO'; // HERO, QUIZ, LOADING, RESULT
    ...
    <div class="flex-1 flex flex-col items-center px-4 py-12 md:py-20 fade-in">
      <div class="max-w-4xl w-full">
        ...
        <div class="mt-12 text-center space-y-8">
          ...
          <a href="#" class="btn-primary inline-flex items-center gap-4 px-12 py-7 text-2xl font-black text-white rounded-full shadow-2xl hover:scale-105 transition-all">
